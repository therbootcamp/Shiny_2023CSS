...
1.  Öffne dein `TheRBootcamp` R project. Es sollte einen `data` Ordner enthalten, indem der im Tab `Datensatz` beschriebene Datensatz `covid.csv` zu finden ist. 
...
3.  Speichere das neue Skript unter dem Namen `app.R` in einen Unterordner.

4.  Lade das `shiny` Paket und alle weiteren Pakete, die du verwenden möchtest.

5.  Lade den Datensatz `covid.csv`.
...
##### Variablenbeschreibungen `covid.csv`
