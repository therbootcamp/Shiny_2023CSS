...
1. Entickeln wir die letzte Version des DataViewer, in dem wir eine Download einbauen. 
  ...
  sidebarLayout(
    sidebarPanel(
      fileInput("daten", 
                ...
                buttonLabel = "Suche...", 
                placeholder = "Wähle ein Datei"),
      textAreaInput("dplyr", "Wrangling Code"),
      actionButton("dplyr_run", "Code ausführen", width = "100%"),
      br(),br(), 
...
observeEvent(req(input$dplyr_run), {
    
    daten(try(eval(parse(text = input$dplyr))))
